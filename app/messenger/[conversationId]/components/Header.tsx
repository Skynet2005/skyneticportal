...
import useActiveList from "@/app/utils/messenger/useHooks/useActiveList";
...
const Header: React.FC<HeaderProps> = ({ conversation }) => {
  ...
  <>
    ...
    />
    <div 
      className="bg-neutral-900 text-white w-full flex border-b-[1px] sm:px-4 py-3 px-4 lg:px-6 justify-between items-center shadow-sm">
